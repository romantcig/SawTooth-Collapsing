...
- [x] **Phase 10: Token 压力与触发统一** - 让本地估算、API actual、辅助请求隔离和最终压缩判定形成统一可审计入口 (completed 2026-07-15)
...
- [x] 10-01-PLAN.md — 建立原子 pressure baseline、指纹持久化与冷启动恢复契约
- [x] 10-02-PLAN.md — 严格识别 Claude Code 2.1.207 session title 受控语言后缀
- [x] 10-03-PLAN.md — 识别 2.1.207 subagent attribution 并贯穿 request role

**Wave 2**

- [x] 10-04-PLAN.md — 统一 full-local/actual+delta 决策、主管线入口与 JSON/SSE baseline 写回

**Wave 3**

- [x] 10-05-PLAN.md — 输出 request_id 双阶段 pressure facts、单条摘要与敏感信息门禁
...
| 10. Token 压力与触发统一 | v1.1 | 5/5 | Complete    | 2026-07-15 |
